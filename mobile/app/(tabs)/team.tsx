...
const styles = StyleSheet.create({
  ...
  addBtn: { width: 38, height: 38, borderRadius: 19, backgroundColor: '#22C55E', alignItems: 'center', justifyContent: 'center' },
  card: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#fff', borderRadius: 12, padding: 14, marginBottom: 8 },
  avatar: { width: 40, height: 40, borderRadius: 20, backgroundColor: '#22C55E22', alignItems: 'center', justifyContent: 'center', marginRight: 12 },
  avatarText: { fontSize: 17, fontWeight: '700', color: '#22C55E' },
  info: { flex: 1 },
  ...
  btnSave: { flex: 1, padding: 13, borderRadius: 10, backgroundColor: '#22C55E', alignItems: 'center' },
